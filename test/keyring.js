...
//var Keyring = typeof window != 'undefined' && window.keyring ? window.keyring : import '../dist/openpgp-keyring';

var Keyring = require('../dist/openpgp-keyring').default;
...
describe("Keyring", function() {
  ...
  it('customize localstorage itemname', function() {
    var localstore1 = new Keyring.localstore('my-custom-prefix-');
    var localstore2 = new Keyring.localstore('my-custom-prefix-');
    var localstore3 = new Keyring.localstore();
  ...
  it('emptying keyring and storing removes keys', function() {
    ...
    var localstore = new Keyring.localstore('remove-prefix-');
